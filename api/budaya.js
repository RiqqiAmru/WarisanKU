const budaya = [
  {
    ...
    tarian: [
      ...
      },
      {
        ...
        gambar: 'seudati.webp',
        description:
          'Tarian ini merupakan tarian yang sangat populer di Aceh. Tarian ini biasanya ditampilkan pada acara-acara besar seperti pernikahan, penyambutan tamu, dan lain-lain. Tarian ini biasanya ditampilkan oleh sekelompok penari yang terdiri dari laki-laki dan perempuan. Tarian ini biasanya diiringi dengan alat musik tradisional seperti gendang, rebana, dan lain-lain.',
      },
      {
        nama: 'Bines',
        gambar: 'bines.webp',
        description:
          'Tarian daerah Aceh bernama tari bines berasal dari Kabupaten Gayo Lues yang umumnya akan dipertunjukan oleh sekelompok wanita. Untuk jumlah penarinya sendiri harus berjumlah genap dari 10, 12, dan angka genap lainnya. Ciri khas dari tarian Aceh ini adalah tarian yang dilakukan dengan gerakan lambat dan berkembang menjadi cepat sampai akhirnya berhenti secara serentak yang hampir serupa dengan tari saman. Selain itu, para penonton yang ingin memberikan uang juga harus menyimpan uang tersebut di atas kepala penari. Uang tersebut dianggap sebagai pengganti bunga yang sudah diberikan penari ketika akhir acara. Sedangkan kostum yang dipakai dalam tarian ini terdiri dari baju lukup, kain sarung yang seragam, kain panjang, hiasan di bagian leher dan juga hiasan tangan seperti topong gelang dengan diiringi lagu Jangin Bines.',
      },
    ],
    upacara: [
      {
    ...
    senjata: [
      {
        ...
        gambar: 'rencong-meupocok.jpg',
        description:
          'Meupecok adalah jenis rencong yang masuk senjata golongan atas bagi rakyat Aceh.Hal ini merujuk pada fungsinya yang dahulu hanya diperuntukkan sebagai senjata para sultan, sedangkan sekarang lebih difungsikan untuk mendukung kegiatan adat.Keunikan senjata tradisional ini terletak pada pangkal bilah di atas gagang yang terdapat pucuk dari bahan emas murni.',
      },
      {
        nama: 'Rencong Meucugek',
        gambar: 'rencong-meucugek.jpg',
        description:
          'Penamaan rencong meucugek berdasarkan pada komposisi senjatanya yang memiliki cugek, yaitu suatu perekat sekaligus penahan pada gagang pegangan.Gagang ini melengkung ke arah mata rencong hingga 90º atau sekitar 8-10 cm.Cugek ini memberikan kekuatan pegangan saat rencong digunakan sehingga tidak mudah lepas dari tangan.Penggunaan rencong meucugek sangat terkenal sebagai alat tikam andalan untuk melawan penjajahan Belanda.',
      },
    ],
  },
  {
    ...
    pakaian: [
      {
        nama: 'Baju Pang si dan Baju kurung',
        gambar: 'pakaian-adat-bangka-belitung.jpg',
        description:
  ...
  },
  {
    ...
    upacara: [
      {
        nama: 'Gawai Dayak',
        gambar: 'gawaidayak.jpg',
        description:
          'festival budaya yang dirayakan oleh suku Dayak untuk menyambut panen padi dan sebagai ungkapan syukur kepada roh-roh padi.',
      },
    ],
    pakaian: [
      {
  ...
  },
  {
    ...
    upacara: [
      {
        nama: 'Upacara Batimung',
        gambar: 'batimung.jpg',
        description: 'upacara adat pengantin Banjar untuk membersihkan badan.',
      },
    ],
    pakaian: [
      {
    ...
    tarian: [
      {
        ...
        description: 'Tarian menyambut para tamu disertai kebesaran adat.',
      },
    ],
    upacara: [
      {
    ...
    tarian: [
      {
        ...
        description: 'Tarian menyambut para tamu yang dihormati.',
      },
    ],
    upacara: [
      {
    ...
    rumah: [
      {
        ...
        gambar: 'joglo.jpg',
        description:
          'Secara sederhana, bagian khusus yang terdapat di Joglo adalah pendopo, sentong, dalem, dan pawon. Pendopo adalah ruang tengah atau ruang utama yang biasa digunakan untuk menerima tamu. Sentong berarti kamar, biasanya ada tiga.',
      },
      {
    ...
    rumah: [
      {
        ...
        gambar: 'rumah-adat-bali.jpg',
        description:
          'Ciri rumah ini adalah di depan rumahnya ada semacam gapura. Begitu masuk ke dalam akan ditemui balai bengong, yang berfungsi sebagai tempat bersantai.',
      },
    ],
    senjata: [
      {
    ...
    rumah: [
      {
        ...
        gambar: 'honai.jpg',
        description:
          'Honai merupakan sebutan untuk rumah adat yang ditempati oleh laki-laki. Sementara itu, rumah untuk perempuan memiliki sebutan yang berbeda, yaitu, Ebeai. Keduanya sama-sama rumah khas Papua dan mampu menampung lima hingga sepuluh orang.',
      },
    ],
    senjata: [
      {
  ...
  },
  {
    ...
    rumah: [
      {
        nama: 'Rumah Honai',
        gambar: 'rumah-honai.jpg',
        description:
          'Rumah adat Papua yang sering muncul pada saat masih sekolah adalah rumah Honai yang dihuni Suku Dani. Rumah ini membentuk lingkaran yang terbuat dari kayu-kayu kuat dan tersusun sejajar. Rumah Honai hanya terdapat satu pintu tanpa jendela dengan ketinggian 2,5 meter serta lebar 5 meter. Nama Honai memiliki arti khusus, Hun yang berarti laki-laki dan ai berarti rumah. Jadi, dapat diartikan bahwa rumah ini khusus untuk laki-laki yang sudah dewasa.',
      },
      {
        nama: 'Rumah Kariwar',
        gambar: 'rumah-kariwari.jpg',
        description:
      ...
      {
        nama: 'Rumah Jew',
        gambar: 'rumah-jew.jpg',
        description:
          'Rumah yang memiliki ukuran dengan panjan 15 meter dan lebar 10 meter dihuni oleh Suku Asmat. Rumah adat ini memanfaatkan akar-akar rotan pilihan sebagai pondasi rumah. Rumah adat Jew disebut sebagai rumah bujang, karena hanya boleh ditempati laki-laki yang belum menikah dan anak laki-laki yang berumur di bawah 10 tahun. Perempuan tidak boleh masuk ke dalam.',
      },
      {
        nama: 'Rumah Ebei',
        gambar: 'rumah-ebei.jpg',
        description:
          'Rumah ini hanya dihuni oleh perempuan Suku Dani kebalikan dari rumah hanoi, anak laki-laki kecil dapat tinggal di rumah ini hingga mereka menjadi dewasa dan siap pindah ke rumah Hanoi. Ebei berarti tubuh perempuan yang mempunyai filosofi sebagai tubuh kehidupan bagi semua orang sebelum lahir ke dunia. Oleh karena itu, rumah ini dijadikan tempat belajar untuk menjadi istri dan ibu yang baik bagi perempuan yang beranjak dewasa dan siap menikah.',
      },
      {
        nama: 'Rumah Hunila',
        gambar: 'rumah-hunila.jpg',
        description:
          'Rumah Suku Dani yang lain adalah Hunila. Rumah ini memiliki bentuk panjang dan lebih luas daripada rumah adat lainnya serta digunakan untuk menyimpan berbagai peralatan masak dan bahan makanan. Rumah Hunila ini dijadikan sebagai dapur umum untuk beberapa rumah Honai dan Ebei guna melakukan produksi makanan ke seluruh rumah.',
      },
    ],
    senjata: [
      {
